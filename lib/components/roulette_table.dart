                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      child: const RCell("1st 12", RCellType.flat)
                                    ),
                                    Row(
                                      children: const [
                                        Expanded(flex: 1, child: RCell("1 to 18", RCellType.flat)),
                                        Expanded(flex: 1, child: RCell("EVEN", RCellType.flat))
                                      ],
                                    )
                                  ],
                                )
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(border: Border.all(color: Colors.white, width: 1)),
                                      child: const RCell("2nd 12", RCellType.flat)
                                    ),
                                    Row(
                                      children: const [
                                        Expanded(flex: 1, child: RCell("", RCellType.diamondRed)),
                                        Expanded(flex: 1, child: RCell("", RCellType.diamondBlack))
                                      ],
                                    )
                                  ],
                                )
                              ...
                              SizedBox(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      children: const [
                                        Expanded(flex: 1, child: RCell("ODD", RCellType.flat)),
                                        Expanded(flex: 1, child: RCell("19 to 36", RCellType.flat))
                                      ],
                                    )
                                  ],
                                )
